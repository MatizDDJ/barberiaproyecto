                ...
                <div className="py-12 text-center space-y-6">
                  ...
                  <div className="pt-6 border-t border-border mt-6">
                    <p className="text-sm text-muted-foreground mb-4">
                      ¿Querés confirmar tu reserva directamente con nosotros?
                    </p>
                    <Button
                      type="button"
                  ...
                  <div className="pt-4">
                    <p className="text-xs text-muted-foreground text-center">
                      También podés gestionar tus reservas en{" "}
                      <a href="/mis-reservas" className="text-accent hover:underline font-medium">
                        Mis Reservas
                      </a>
                    </p>
                  </div>
